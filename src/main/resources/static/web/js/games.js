                    ...
                    let scorePlayerId = data[i].scores[j].player;
                                      ...
                                      for (let k = 0; k < players.length; k++) {
                                          ...
                                          if (players[k].id == scorePlayerId) {
                                              players[k].scores.push(data[i].scores[j]);    //si agrego score me elimina los 1 de lost
  ...
  for (let m = 0; m < players.length; m++) {
      ...
      if (players[m].scores.length > 0) {
          ...
          for (let n = 0; n < players[m].scores.length; n++) {
              if (players[m].scores[n].score == 0.0) {
                  countLost++;
              } else if (players[m].scores[n].score == 0.5) {
                  countTied++;
              } else if (players[m].scores[n].score == 1.0) {
                  countWon++;
              }
          }
